  ...
  public static class TOOLS {
    ...
    public static class PROTOCOL_BLOCKER {
      ...
      @Comment({
          ...
          @CommentValue("1.20, 1.20.2, 1.20.3, 1.20.5, 1.21, 1.21.2, 1.21.4, 1.21.5, 1.21.6, 1.21.7, 1.21.9, 1.21.11, LATEST"),
      })
    ...
    public static class BRAND_CHANGER {
      ...
      public String PING_BRAND = "YourServer 1.12.2-1.21.11";
